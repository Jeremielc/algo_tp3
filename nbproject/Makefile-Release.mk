...
${OBJECTDIR}/sources/functions.o: sources/functions.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/functions.o sources/functions.c

${OBJECTDIR}/sources/lists.o: sources/lists.c 
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/lists.o sources/lists.c

${OBJECTDIR}/sources/main.o: sources/main.c 
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/main.o sources/main.c
